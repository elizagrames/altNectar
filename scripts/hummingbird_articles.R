...
file.list <- list.files("./data/hummingbird-articles", full.names = T)
...
articles <- articles.read[!duplicated(articles.read[,1:4]),]

# Clean article dates and locations --------------------------------------------

articles <- split_date(articles)

# Manually check early dates

# Valid:
# Sept 1891, San Francisco Call 2151 -- 7122
# 1891 Monterey Cypress (96) -- 5067
# 1891 Ferndale Enterprise (98) -- 5069
# Record Union January 1898 (38, 46) -- 5009 
# Sacramento Bee July 28, 1900 -- 4986 / 15
# LA Times December 22, 1918 -- 4998 / 27
# Evening Vanguard 1923 -- 5106
# San Bernardino Sun August 1929 -- 4990
# Oakland Tribune August 1929 -- 4996

articles[articles$year<1930,1:4]

checkthese <- articles[articles$year < 1930,]
checking <- checkthese[order(checkthese$year),1:5]
checking[,1:4]

toss <- as.numeric(rownames(checking))
toss <- toss[!toss%in%c(7122, 96, 98, 38, 15, 27, 135, 19, 25)]

articles <- articles[-toss,]
...
write.csv(relative.counts, file="./output/relative_counts_hummingbirds.csv")
write.csv(placeholder, file="./output/absolute_counts_hummingbirds.csv")
